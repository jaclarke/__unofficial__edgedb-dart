...
.. list-table::
  ...
  * - EdgeDB type
    - Dart type
  * - Sets
    - `List\<dynamic\> <https://api.dart.dev/stable/3.6.1/dart-core/List-class.html>`__
  * - Arrays
    - `List\<dynamic\> <https://api.dart.dev/stable/3.6.1/dart-core/List-class.html>`__
  * - Objects
    - `Map\<String, dynamic\> <https://api.dart.dev/stable/3.6.1/dart-core/Map-class.html>`__
  * - Tuples (``tuple<x, y, ...>``)
    - `List\<dynamic\> <https://api.dart.dev/stable/3.6.1/dart-core/List-class.html>`__
  ...
  * - Enums
    - `String <https://api.dart.dev/stable/3.6.1/dart-core/String-class.html>`__
  * - ``str``
    - `String <https://api.dart.dev/stable/3.6.1/dart-core/String-class.html>`__
  * - ``bool``
    - `bool <https://api.dart.dev/stable/3.6.1/dart-core/bool-class.html>`__
  * - ``int16``/``int32``/``int64``
    - `int <https://api.dart.dev/stable/3.6.1/dart-core/int-class.html>`__
  * - ``float32``/``float64``
    - `double <https://api.dart.dev/stable/3.6.1/dart-core/double-class.html>`__
  * - ``json``
    - as decoded by ``json.decode()``
  * - ``uuid``
    - `String <https://api.dart.dev/stable/3.6.1/dart-core/String-class.html>`__
  * - ``bigint``
    - `BigInt <https://api.dart.dev/stable/3.6.1/dart-core/BigInt-class.html>`__
  * - ``decimal``
    - *(unsupported)*
  * - ``bytes``
    - `Uint8List <https://api.dart.dev/stable/3.6.1/dart-typed_data/Uint8List-class.html>`__
  * - ``datetime``
    - `DateTime <https://api.dart.dev/stable/3.6.1/dart-core/DateTime-class.html>`__
  * - ``duration``
    - `Duration <https://api.dart.dev/stable/3.6.1/dart-core/Duration-class.html>`__
  * - ``cal::local_datetime``
  ...
  * - ``ext::pgvector::vector``
    - `Float32List <https://api.dart.dev/stable/3.6.1/dart-typed_data/Float32List-class.html>`__ (`List\<double\> <https://api.dart.dev/stable/3.6.1/dart-core/List-class.html>`__)
